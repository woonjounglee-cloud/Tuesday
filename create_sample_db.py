...
try:
    ...
    roi_sample_data = [
        ['449170', '', 5504005, 52, 110212, 5731024, 4.1],
        ['411060', '', 1942055, 85, 27185, 2310725, 19.0],
        ['468630', '', 736740, 66, 11985, 791010, 7.4],
        ['476760', '', 1291165, 127, 10265, 1303655, 1.0],
        ['0046A0', '', 331495, 33, 10180, 335940, 1.3],
        ['273130', '', 446440, 4, 116270, 465080, 4.2],
        ['379800', '', 1627410, 78, 22055, 1720290, 5.7],
        ['379810', '', 1716035, 90, 23870, 2148300, 25.2],
        ['489250', '', 1990000, 165, 10842, 1788930, -10.1],
        ['294400', '', 443243, 10, 72105, 721050, 62.7],
        ['453870', '', 912282, 73, 14310, 1044630, 14.5]
    ]
    ...
    portfolio_sample_data = [
        ['449170', '', '안전자산', '현금', 10.0, 31.2, -3894961],
        ['411060', '', '대체자산', '금', 15.0, 12.6, 443370],
        ['468630', '', '채권', '미국회사채', 5.0, 4.3, 127022],
        ['476760', '', '채권', '미국장기채', 5.0, 7.1, -385623],
        ['0046A0', '', '채권', '미국단기채', 2.5, 1.8, 123076],
        ['273130', '', '채권', '국채', 2.5, 2.5, -6064],
        ['379800', '', '주식', '미국지수', 20.0, 9.4, 1951837],
        ['379810', '', '주식', '미국지수', 20.0, 11.7, 1523827],
        ['489250', '', '주식', '미국배당', 10.0, 9.7, 47133],
        ['294400', '', '주식', '국내지수', 5.0, 3.9, 196982],
        ['453870', '', '주식', '신흥국', 5.0, 5.7, -126598]
    ]
