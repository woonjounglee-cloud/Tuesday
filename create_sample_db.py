...
try:
    ...
    roi_sample_data = [
        ['069500', 'KODEX 200', 1000000, 50, 20000, '', ''],
        ['114800', 'KODEX 인버스', 500000, 30, 16500, '', ''],
        ['123310', 'TIGER 200', 750000, 40, 18750, '', ''],
        ['148070', 'KOSEF 국고채10년', 1250000, 60, 20800, '', '']
    ]
    ...
    portfolio_sample_data = [
        ['069500', 'KODEX 200', '국내주식', 'ETF', 25.0, '', '', ''],
        ['114800', 'KODEX 인버스', '국내주식', 'ETF', 20.0, '', '', ''],
        ['123310', 'TIGER 200', '국내주식', 'ETF', 30.0, '', '', ''],
        ['148070', 'KOSEF 국고채10년', '채권', 'ETF', 25.0, '', '', '']
    ]
    ...
    print('openpyxl is not installed. Skipping sample file creation.')
    print('The application will create the file on first run.')
